...
import com.example.pidev.Service.Classe.EmailValidator;
import com.example.pidev.Service.Classe.PasswordTokenService;
...
public class EmailService implements EmailSender {
    ...
    public String forgetpassword(String email) {
        ...
        User u = userRepo.findByMail(email);//.orElse(null);
